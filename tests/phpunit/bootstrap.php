...
// Make CRM_Gdprx_ExtensionUtil available.
require_once __DIR__ . '/../../gdprx.civix.php';
...
addExtensionToClassLoader('de.systopia.gdprx');
 ...
 */
function _gdprx_test_civicrm_container(ContainerBuilder $container): void {
}
